...
for (let i = 0; i < count * 3 * 3; i++) {
    randPosArray[i] = (Math.random() - 0.5) * 2
}

const randPosAttribute = new THREE.BufferAttribute(randPosArray, 3)
const randGeometry = new THREE.BufferGeometry()
randGeometry.setAttribute('position', randPosAttribute)
