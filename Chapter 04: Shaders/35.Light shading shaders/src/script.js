...
directionalLightHelper.material.color = new THREE.Color(0.1, 0.1, 1.0)
...
pointLightHelper.material.color = new THREE.Color(1.0, 0.1, 0.1)
...
pointLightHelper2.material.color = new THREE.Color(0.1, 1.0, 0.5)
