...
// Draw
displacement.context.drawImage(displacement.glowImage, 20, 20)
 ...
 * Particles
 */
const texture = textureLoader.load('./picture-4.png')

const particlesGeometry = new THREE.PlaneGeometry(10, 10, 256, 256)
particlesGeometry.setIndex(null) // Reduce number of particles render at the same spot
...
const tick = () =>
{
    ...
    displacement.context.drawImage(displacement.glowImage, displacement.canvasCursor.x - glowSize * 0.5, displacement.canvasCursor.y - glowSize * 0.5, glowSize, glowSize)
