...
import vertexSea from './shaders/vertexSea.glsl'
import fragmentSea from './shaders/fragmentSea.glsl'
...
// Color
debugObject.deptColor = '#334e9e'
debugObject.surfaceColor = '#55f7c1'
...
const waterMaterial = new THREE.ShaderMaterial({
    ...
    uniforms: {
        ...
        uDeptColor : {value: new THREE.Color(debugObject.deptColor)},
...
gui.addColor(debugObject, 'deptColor').name('DeptColor').onChange(() => {
    waterMaterial.uniforms.uDeptColor.value.set(debugObject.deptColor)
})
